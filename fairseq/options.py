...
def get_generation_parser(interactive=False, default_task="translation"):
    ...
    if interactive:
        ...
        add_non_interactive_args(parser)
    return parser
...
def add_non_interactive_args(parser):
    group = parser.add_argument_group("Non Interactive")
    # fmt: off
    group.add_argument('--buffer-size', default=0, type=int, metavar='N',
                       help='read this many sentences into a buffer before processing them')
    group.add_argument('--input', default='-', type=str, metavar='FILE',
                       help='file to read from; use - for stdin')
    group.add_argument('--output', type=str, metavar='FILE',
